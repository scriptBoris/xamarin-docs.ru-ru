...
1. Выберите **Параметры IPA iOS > Настройка > Специальный** (если вариант **Специальный** отсутствует, выберите вместо него вариант **Выпуск**) и установите флажок для создания IPA-файла:
