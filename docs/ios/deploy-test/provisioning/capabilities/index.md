...
-   Убедитесь в том, что идентификатор был правильно создан и зарегистрирован в разделе  **Сертификаты, идентификаторы и профили** на портале разработчика Apple.
-   Убедитесь, что служба добавлена в идентификатор приложения (или расширения), а также что служба настроена на использование группы приложений/идентификатора продавца/контейнера, созданных ранее в разделе  **Сертификаты, идентификаторы и профили**  на портале разработчиков Apple.
