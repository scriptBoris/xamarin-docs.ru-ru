...
3.  В разделе **Идентификаторы** выберите **Группы приложений** и нажмите кнопку **+** , чтобы создать новую группу.
4.  Введите **Имя** и **Идентификатор** для новой группы и нажмите кнопку **Продолжить** : 
   
    ![Добавление сведений о группе приложений](app-groups-capabilities-images/image52.png)

5.  Нажмите кнопку  **Зарегистрировать** , чтобы создать группу, а затем щелкните  **Готово** , чтобы вернуться к списку зарегистрированных групп приложений.
...
2.  В меню  **Ресурсы программы** выберите  **Сертификаты, идентификаторы и профили**.
3.  В разделе **Идентификаторы** выберите **Идентификаторы приложений** и нажмите кнопку **+** , чтобы создать новый идентификатор.
4.  Введите имя для идентификатора приложения и присвойте ему явный идентификатор.
5.  В разделе  **Службы приложений** активируйте **Группы приложений** и нажмите кнопку "Продолжить":

    ![Добавление служб приложений группы приложений](app-groups-capabilities-images/image53.png)

6.  Проверьте параметры и нажмите кнопку  **Зарегистрировать** , чтобы создать идентификатор приложения.
7.  Нажмите кнопку  **Готово** , чтобы вернуться к списку зарегистрированных идентификаторов приложений.
8.  Выберите в списке только что созданный идентификатор приложения и нажмите кнопку  **Изменить** :

    ![Выберите идентификатор приложения в списке](app-groups-capabilities-images/image54.png)

9.  В разделе  **Группа приложений** нажмите кнопку **Изменить** :

    ![Выберите идентификатор приложения в списке](app-groups-capabilities-images/image55.png)

10. Выберите созданную ранее группу приложений и нажмите кнопку  **Продолжить** :

    ![Добавление группы приложений](app-groups-capabilities-images/image56.png)

11. Нажмите кнопку  **Назначить** , а затем кнопку  **Готово** , чтобы вернуться к списку зарегистрированных идентификаторов приложений.
