...
description: В этом руководстве описывается использование функции "Связать с Mac" для подключения Visual Studio 2017 к узлу сборки Mac. Он описывает, как включить удаленный вход на Mac, подключиться к Mac из Visual Studio 2017, вручную добавить узел сборки Mac на компьютере с Windows и многое другое.
ms.prod: xamarin
