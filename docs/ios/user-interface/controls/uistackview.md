...
> [!IMPORTANT]
> Обратите внимание на то, что хотя StackView поддерживается в конструкторе iOS, могут возникнуть ошибки удобства использования при использовании стабильный канал. Переключение бета-версию или альфа-каналы должны устранить эту проблему. Мы решили представить в этом пошаговом руководстве, с помощью Xcode до исправления, необходимые реализуются в стабильном канале.
