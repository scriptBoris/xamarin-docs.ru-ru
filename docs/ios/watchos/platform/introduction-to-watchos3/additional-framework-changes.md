...
- Новое событие движения устройство использует акселерометр и гироскоп для предоставления обновлений движения и ориентацию. Приложения могут регистрироваться для этого обновления (по ставкам до 100 Гц).
