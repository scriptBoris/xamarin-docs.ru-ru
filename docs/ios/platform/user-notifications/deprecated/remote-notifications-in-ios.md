...
description: В этом документе описаны способы работы с push-уведомлений в iOS 9 и более ранних версий. В нем описывается сертификатов, регистрации с Apple Push-уведомления шлюза Service (APNS) и многое другое.
ms.prod: xamarin
