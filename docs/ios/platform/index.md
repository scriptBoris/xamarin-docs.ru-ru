...
> [!WARNING]
> 12 поддержку Xamarin iOS в настоящее время в предварительной версии, что означает, что она может содержать ошибки, не все компоненты, и может измениться.
> Используйте для экспериментов только.

Этот документ описывает iOS 12 функции, доступные для использования при создании приложений, Xamarin.iOS.
...
В этом документе описаны новые и обновленные возможности iOS 11 и 9 Xcode, например ARKit, Core ML, NFC ядра, перетаскивание, MapKit, PDFKit, SiriKit и концепции. Ссылки на руководства, описывающие способы использования этих функций с Xamarin.iOS.
...
iOS 10 содержит несколько новых API-интерфейсов и служб, которые позволяют разрабатывать приложения с помощью новых функций и возможностей. Благодаря iOS 10 приложения имеют новые возможности, таких как расширение карты, сообщения, Phone и Siri. В этом разделе показано реализует, чтобы воспользоваться преимуществами этих функций в приложении Xamarin.iOS.
...
iOS 8 сделанных большое количество изменений в операционную систему iOS 7. Здесь показано, что это такое и способ их использования.
...
## <a name="ios-extensionsiosplatformextensionsmd"></a>[операций ввода-вывода расширения](~/ios/platform/extensions.md)
...
## <a name="graphics-and-animation-in-iosiosplatformgraphics-animation-iosindexmd"></a>[Графики и анимации в iOS](~/ios/platform/graphics-animation-ios/index.md)
...
## <a name="ios-gaming-apisiosplatformgamingindexmd"></a>[iOS игры API-интерфейсы](~/ios/platform/gaming/index.md)
...
## <a name="social-frameworkiosplatformsocial-frameworkmd"></a>[Социальные framework](~/ios/platform/social-framework.md)
...
## <a name="exception-marshalingexception-marshalingmd"></a>[Маршалинг исключения](exception-marshaling.md)
