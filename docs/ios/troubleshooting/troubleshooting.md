...
## <a name="deploy-to-device-fails-with-systemexception-amdeviceinstallapplication-returned-3892346901"></a>Разверните устройства завершается ошибкой с System.Exception. AMDeviceInstallApplication возвращается 3892346901
