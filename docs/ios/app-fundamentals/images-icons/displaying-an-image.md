...
Добавлен в iOS 7, **наборы изображений каталоги активов** содержат всех версий или представление изображения, которые необходимы для поддержки различных устройств и масштабировать факторов для приложения. А не полагаться на имя файла изображения для ресурсов (см. в разделе [независимых изображения с разрешением и терминология, изображение](~/ios/app-fundamentals/images-icons/displaying-an-image.md)), **наборы изображений** использовать Json-файл, чтобы указать, какой образ принадлежит какие устройства или разрешение . Это предпочтительный способ управления и поддержки образов ОС iOS (в iOS 9 или более поздней версии).
...
4. Отсюда перетащите изображения для каждого из различных устройств и и необходимые разрешения. 
...
2. Выберите **добавить набор изображений** и редактор задать изображение будет отображаться для нового набора изображений. Отсюда перетащите изображения для каждого из различных устройств и и необходимые разрешения. 
