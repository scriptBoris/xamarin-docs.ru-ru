...
## <a name="creating-a-view-vontroller"></a>Создание vontroller представление
...
При создании проекта iOS в Visual Studio, на экран запуска автоматически предоставляется в виде файла .xib, который можно найти в **ресурсы** папки внутри проекта.

# <a name="visual-studio-for-mactabmacos"></a>[Visual Studio для Mac](#tab/macos)

При создании проекта iOS в Visual Studio для Mac, на экран запуска предоставляется в виде файла раскадровки.
...
### <a name="creating-a-launch-image-for-pre-ios-8-applications"></a>Создание изображения запуска для предварительной iOS 8 приложений
