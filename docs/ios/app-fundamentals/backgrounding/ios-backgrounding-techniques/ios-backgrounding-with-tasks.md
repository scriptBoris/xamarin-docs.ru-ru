...
1.  **Safe фоновой задачи** — вызывается в любом месте приложения, где у вас есть задачу вы не хотите прерванного приложения следует вводить фона.
