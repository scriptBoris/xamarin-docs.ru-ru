...
- iOS: Темная текст на фоне света
- Android: Светло-текст на темном фоне (в книге) или темно-текст на фоне светлой (для проектирования материалы по совместимости приложений в **master** ветвь репозиторий примеров кода)
- Универсальной платформы Windows: Темно-текст на светлым фоном
- Windows 8.1: Светло-текст на темном фоне
- Windows Phone 8.1: Светло-текст на темном фоне
...
При разработке для Android, можно переключиться на темно на light схему, указав "светлой" темой в файле Android.Manifest.xml или [Добавление AppCompat и материальному дизайну](~/xamarin-forms/platform/android/appcompat.md).
