...
Второй метод предполагает удаление ненужных элементов. Например, в следующем примере кода показан макет страницы, отображающий ряд элементов [`Label`](xref:Xamarin.Forms.Label):
