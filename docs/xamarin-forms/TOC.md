...
#### [Часть 2. Глубокое погружение](get-started/hello-xamarin-forms/deepdive.md)
...
#### [Часть 2. Глубокое погружение](get-started/hello-xamarin-forms-multiscreen/deepdive.md)
...
#### [Навигация с помощью клавиатуры](app-fundamentals/accessibility/keyboard.md)
...
### [Оболочка](app-fundamentals/shell.md)
...
### [Визуальный элемент](user-interface/visual.md)
...
#### [Хранилище Azure](data-cloud/storage/azure-storage.md)
### [Поиск данных в облаке](data-cloud/search/index.md)
#### [Поиск Azure](data-cloud/search/azure-search.md)
### [Бессерверные приложения](data-cloud/serverless/index.md)
#### [Функции Azure](data-cloud/serverless/azure-functions.md)
