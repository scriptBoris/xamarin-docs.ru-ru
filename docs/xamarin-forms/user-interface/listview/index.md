...
3. **[Внешний вид списка](customizing-list-appearance.md)**  &ndash; настройки внешнего вида ListView. Задать заголовки и нижние колонтитулы, включите группы и изменять высоту строк.
4. **[Интерактивные возможности](interactivity.md)**  &ndash; обработки касания и выбранные параметры, реализуйте по запросу для обновления и добавьте контекстных действий.
