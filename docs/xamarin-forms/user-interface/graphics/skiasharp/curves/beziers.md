...
Известно, кривых Безье подходят для интерактивной разработки: они правильно &mdash; другими словами, не существует, вызывающие кривая, становятся бесконечное или неудобным особенностей &mdash; , и они обычно эстетично . Контурам символов на компьютере шрифтов, обычно определяются с помощью кривых Безье:
...
Итоговый кривой начинается с начальной точки и заканчивается в конечной точке. Кривая обычно не проходит через две контрольные точки; Вместо этого они работают гораздо like магниты для извлечения кривой к их.
...
## <a name="bzier-curve-approximation-to-circular-arcs"></a>Приближения кривой Безье в дуги
