...
Этой серии статей будет ограничивать себя `SKBitmap` цвета форматы, используемые по умолчанию, если аргумент `SKColorType` элемент указан. Этот формат по умолчанию зависит от базовой платформы. Для платформ, поддерживаемых Xamarin.Forms является тип цвета по умолчанию:
