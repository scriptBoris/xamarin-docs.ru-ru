---
title: Установка значений специальных возможностей в элементах пользовательского интерфейса
description: В этой статье объясняется, как использовать класс AutomationProperties, таким образом, чтобы средство чтения с экрана можно говорить об элементах на странице.
ms.prod: xamarin
...
ms.locfileid: "38998920"
---
# <a name="setting-accessibility-values-on-user-interface-elements"></a>Установка значений специальных возможностей в элементах пользовательского интерфейса
...
Xamarin.Forms позволяет значения специальных возможностей, которые необходимо установить в элементах пользовательского интерфейса с помощью следующих вложенных свойств:
...
В этой статье было рассмотрено, как задание значений специальных возможностей пользователя элементы интерфейса в приложении Xamarin.Forms с помощью присоединенных свойств из `AutomationProperties` класса. Они присоединены значений собственного специальных возможностей набора свойств таким образом, чтобы средство чтения с экрана можно говорить об элементах на странице.
