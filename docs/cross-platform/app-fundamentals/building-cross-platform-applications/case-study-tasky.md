---
title: 'Кросс платформенные приложения практический пример: Tasky'
description: В этом документе описывается Tasky переносимой образец приложения был разработан и собран как кросс платформенных мобильных приложений. Он рассматриваются приложения требования, интерфейс, модель данных, основные функциональные возможности, реализации и многое другое.
ms.prod: xamarin
...
ms.locfileid: "34782239"
---
# <a name="cross-platform-app-case-study-tasky"></a>Кросс платформенные приложения практический пример: Tasky
