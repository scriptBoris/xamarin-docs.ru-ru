...
description: Этот документ описывает методы, с помощью которых можно повысить производительность мобильного приложения. Он описывает профилировщик, ресурс IDisposable, слабые ссылки, сборщик мусора SGen, методы сокращения размера и многое другое.
ms.prod: xamarin
...
Дополнительные сведения см. в статье, посвященной [интерфейсу IDisposable](xref:System.IDisposable).
