...
description: Этот документ описывает жизненный цикл разработки программного обеспечения для мобильных устройств, уделяя внимание проектированию взаимодействия с пользователем и пользовательского интерфейса, разработке, стабилизации, распространению и многому другому.
ms.prod: xamarin
