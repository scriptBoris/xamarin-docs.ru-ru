...
<div id="main" class="v2">
                    ...
                    <div class="cardSize">
                        <div class="cardPadding">
                            <div class="card">
                                ...
                                <div class="cardText">
                                    <h3 class="x-hidden-focus">Приступая к работе</h3>
                                    <p>Создайте приложение для Android, iOS и UWP.</p>
                                </div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="cardSize">
                        <div class="cardPadding">
                            <div class="card">
                                ...
                                <div class="cardText">
                                    <h3 class="x-hidden-focus">Примеры</h3>
                                    <p>Примеры компонентов и предварительно созданных приложений.</p>
                                </div>
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="cardPadding">
                            <div class="card">
                                ...
                                <div class="cardText">
                                    ...
                                    <p>Учитесь бесплатно в Интернете или присоединяйтесь к нашим занятиям в реальном времени.</p>
                                </div>
                            </div>
                        </div>
                    </div>
    ...
    <div class="container">
        <h1 class="screenReader">Документация по Xamarin</h1>
        <ul class="pivots">
            <li>
                ...
                <ul id="platforms">
                                        ...
                                        <div class="cardPadding">
                                            <div class="card">
                                                ...
                                                <div class="cardText">
                                                    ...
                                                    <p>Сведения об элементах управления пользовательским интерфейсом в Android, iOS и Windows.</p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="cardSize">
                                        <div class="cardPadding">
                                            <div class="card">
                                                ...
                                                <div class="cardText">
                                                    <h3>XAML</h3>
                                                    <p>Используя XAML, выражайте кроссплатформенные пользовательские интерфейсы декларативно.</p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="cardSize">
                                        <div class="cardPadding">
                                            <div class="card">
                                                ...
                                                <div class="cardText">
                                                    <h3>Функции платформы</h3>
                                                    <p>Работайте с возможностями, предназначенными для конкретных платформ, в Android, iOS и Windows.</p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                        ...
                                        <div class="cardPadding">
                                            <div class="card">
                                                ...
                                                <div class="cardText">
                                                    ...
                                                    <p>Кроссплатформенные API-интерфейсы для общих задач, таких как доступ к файлам, сведения об устройстве, параметры оборудования и многих других.</p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="cardSize">
                                        <div class="cardPadding">
                                            <div class="card">
                                                ...
                                                <div class="cardText">
                                                    <h3>Данные и облачные службы</h3>
                                                    <p>Хранение данных и доступ к облачным службам, таким как Microsoft Azure.</p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="cardSize">
                                        <div class="cardPadding">
                                            <div class="card">
                                                ...
                                                <div class="cardText">
                                                    <h3>Тестирование и развертывание</h3>
                                                    <p>Инструкции по созданию и развертыванию приложений, а также советы по их предварительному тестированию.</p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="cardSize">
                                        <div class="cardPadding">
                                            <div class="card">
                                                ...
                                                <div class="cardText">
                                                    <h3>Дополнительные понятия и внутренние компоненты</h3>
                                                    <p>Как работает Xamarin.Forms.</p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="cardSize">
                                        <div class="cardPadding">
                                            <div class="card">
                                                ...
                                                <div class="cardText">
                                                    <h3>Книга мобильных приложений</h3>
                                                    <p>Изучайте Xamarin.Forms шаг за шагом с помощью этой книги и примеров.</p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="cardSize">
                                        <div class="cardPadding">
                                            <div class="card">
                                                ...
                                                <div class="cardText">
                                                    <h3>Корпоративная электронная документация</h3>
                                                    <p>Архитектурное руководство для разработки адаптируемых, поддерживаемых и проверяемых корпоративных приложений Xamarin.Forms.</p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="cardSize">
                                        <div class="cardPadding">
                                            <div class="card">
                                                ...
                                                <div class="cardText">
                                                    <h3>Начало работы с Android</h3>
                                                    <p>Руководства, которые помогут вам начать работу с Xamarin.Android. Убедитесь в том, что все установлено правильно, и создайте свое первое приложение.</p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="cardSize">
                                        <div class="cardPadding">
                                            <div class="card">
                                                ...
                                                <div class="cardText">
                                                    <h3>Пользовательский интерфейс в Android</h3>
                                                    <p>Дополнительные сведения о полном наборе мини-приложений интерфейса пользователя, доступного на Android.</p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="cardSize">
                                        <div class="cardPadding">
                                            <div class="card">
                                                ...
                                                <div class="cardText">
                                                    <h3>Возможности на платформе Android</h3>
                                                    <p>Работайте с возможностями, предназначенными для конкретных платформ, и последними дополнениями к Android.</p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="cardSize">
                                        <div class="cardPadding">
                                            <div class="card">
                                                ...
                                                <div class="cardText">
                                                    <h3>Данные и облачные службы</h3>
                                                    <p>Хранение данных и доступ к облачным службам.</p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="cardSize">
                                        <div class="cardPadding">
                                            <div class="card">
                                                ...
                                                <div class="cardText">
                                                    <h3>Дополнительные понятия и внутренние компоненты</h3>
                                                    <p>Как работает Xamarin.Android.</p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="cardSize">
                                        <div class="cardPadding">
                                            <div class="card">
                                                ...
                                                <div class="cardText">
                                                    <h3>Wear</h3>
                                                    <p>Разработка приложений для Android Wear.</p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="cardSize">
                                        <div class="cardPadding">
                                            <div class="card">
                                                ...
                                                <div class="cardText">
                                                    <h3>Примеры приложений</h3>
                                                    <p>Примеры телефонов и планшетов Android, которые помогут вам начать работу.</p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="cardSize">
                                        <div class="cardPadding">
                                            <div class="card">
                                                ...
                                                <div class="cardText">
                                                    <h3>Пользовательский интерфейс в iOS</h3>
                                                    <p>Узнайте о полном наборе элементов управления UIKit, доступных на iOS.</p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="cardSize">
                                        <div class="cardPadding">
                                            <div class="card">
                                                ...
                                                <div class="cardText">
                                                    <h3>Возможности на платформе iOS</h3>
                                                    <p>Работайте с возможностями, предназначенными для конкретных платформ, такими как FaceID и ARKit, и последними дополнениями к iOS.</p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="cardSize">
                                        <div class="cardPadding">
                                            <div class="card">
                                                ...
                                                <div class="cardText">
                                                    <h3>watchOS</h3>
                                                    <p>Создание приложений для watchOS.</p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="cardSize">
                                        <div class="cardPadding">
                                            <div class="card">
                                                ...
                                                <div class="cardText">
                                                    <h3>tvOS</h3>
                                                    <p>Создание ТВ-приложений с помощью tvOS.</p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="cardSize">
                                        <div class="cardPadding">
                                            <div class="card">
                                                ...
                                                <div class="cardText">
                                                    <h3>Примеры приложений</h3>
                                                    <p>Приложения и демонстрации кода для iPhone, iPad, Apple Watch и Apple TV.</p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="cardSize">
                                        <div class="cardPadding">
                                            <div class="card">
                                                ...
                                                <div class="cardText">
                                                    <h3>Пользовательский интерфейс в Mac</h3>
                                                    <p>Узнайте о полном наборе элементов управления AppKit, доступных на macOS.</p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="cardSize">
                                        <div class="cardPadding">
                                            <div class="card">
                                                ...
                                                <div class="cardText">
                                                    <h3>Возможности на платформе Mac</h3>
                                                    <p>Работайте с возможностями, предназначенными для конкретных платформ, и последними дополнениями к macOS.</p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="cardSize">
                                        <div class="cardPadding">
                                            <div class="card">
                                                ...
                                                <div class="cardText">
                                                    <h3>Примеры приложений</h3>
                                                    <p>Примеры macOS для начала работы с разработкой C# для настольных компьютеров Mac.</p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                    ...
                    <li>
                        <a data-default="true" href="#Cross-Platform">Кроссплатформенные приложения</a>
                                    ...
                                    <div class="cardSize">
                                        <div class="cardPadding">
                                            <div class="card">
                                                ...
                                                <div class="cardText">
                                                    <h3>Общий доступ к коду</h3>
                                                    <p>Дополнительные сведения о различных параметрах для совместного использования кода и библиотек в Android, iOS и Windows.</p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                        ...
                                        <div class="cardPadding">
                                            <div class="card">
                                                ...
                                                <div class="cardText">
                                                    ...
                                                    <p>Проекты Xamarin можно писать на C# и F# с использованием библиотек, написанных на Visual Basic. Также поддерживаются шаблоны Razor.</p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="cardSize">
                                        <div class="cardPadding">
                                            <div class="card">
                                                ...
                                                <div class="cardText">
                                                    <h3>Производительность и безопасность</h3>
                                                    <p>Рекомендации по обеспечению безопасности и повышению производительности приложения.</p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="cardSize">
                                        <div class="cardPadding">
                                            <div class="card">
                                                ...
                                                <div class="cardText">
                                                    <h3>Развертывание и отладка</h3>
                                                    <p>Советы по отладке и развертыванию.</p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                        ...
                                        <div class="cardPadding">
                                            <div class="card">
                                                ...
                                                <div class="cardText">
                                                    ...
                                                    <p>Рекомендации для разработчиков классических приложений .NET, заинтересованных в создании мобильных приложений.</p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="cardSize">
                                        <div class="cardPadding">
                                            <div class="card">
                                                ...
                                                <div class="cardText">
                                                    <h3>Примеры</h3>
                                                    <p>Кроссплатформенные готовые приложения для пробного использования в Xamarin.</p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
            ...
            <li>
                <a href="#graphics-games">Графика и игры</a>
                                    ...
                                    <div class="cardSize">
                                        <div class="cardPadding">
                                            <div class="card">
                                                ...
                                                <div class="cardText">
                                                    <h3>SkiaSharp</h3>
                                                    <p>Кроссплатформенная двухмерная графика для мобильных и классических приложений.</p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="cardSize">
                                        <div class="cardPadding">
                                            <div class="card">
                                                ...
                                                <div class="cardText">
                                                    <h3>UrhoSharp</h3>
                                                    <p>Кроссплатформенная трехмерная графика и игры.</p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="cardSize">
                                        <div class="cardPadding">
                                            <div class="card">
                                                ...
                                                <div class="cardText">
                                                    <h3>CocosSharp</h3>
                                                    <p>Создание кроссплатформенных двухмерных игр для мобильных устройств.</p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="cardSize">
                                        <div class="cardPadding">
                                            <div class="card">
                                                ...
                                                <div class="cardText">
                                                    <h3>MonoGame</h3>
                                                    <p>Создание игр для мобильных устройств, компьютеров и игровых приставок с помощью C#.</p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                        ...
                                        <div class="cardPadding">
                                            <div class="card">
                                                ...
                                                <div class="cardText">
                                                    ...
                                                    <p>Начните работу с Xamarin за считаные минуты, используя приложение Live Player с Visual Studio.</p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="cardSize">
                                        <div class="cardPadding">
                                            <div class="card">
                                                ...
                                                <div class="cardText">
                                                    <h3>Удаленный симулятор iOS для Windows</h3>
                                                    <p>Используйте iOS Simulator с помощью Visual Studio в Windows.</p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                        ...
                                        <div class="cardPadding">
                                            <div class="card">
                                                ...
                                                <div class="cardText">
                                                    ...
                                                    <p>Осваивайте и отлаживайте пользовательский интерфейс.</p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                        ...
                                        <div class="cardPadding">
                                            <div class="card">
                                                ...
                                                <div class="cardText">
                                                    ...
                                                    <p>Определяйте и устраняйте проблемы с производительностью.</p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                        ...
                                        <div class="cardPadding">
                                            <div class="card">
                                                ...
                                                <div class="cardText">
                                                    ...
                                                    <p>Изучайте C# и платформу Xamarin в интерактивном режиме.</p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="cardSize">
                                        <div class="cardPadding">
                                            <div class="card">
                                                ...
                                                <div class="cardText">
                                                    <h3>Внедрение .NET</h3>
                                                    <p>Позволяет использовать код .NET в других языках программирования.</p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                        ...
                                        <div class="cardPadding">
                                            <div class="card">
                                                ...
                                                <div class="cardText">
                                                    ...
                                                    <p>Как включить проекты Xamarin в непрерывный конвейер по сборке и интеграции.</p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
