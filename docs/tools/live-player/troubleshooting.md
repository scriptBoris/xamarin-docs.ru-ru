...
Убедитесь, что вы выбрали **запускаемым проектом** , соответствующий своего типа устройства (iOS или Android) и что конфигурация соответствует типа устройства (например) **Отладка | iPhone симулятор** для iOS).
