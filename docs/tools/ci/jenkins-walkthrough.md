...
description: В этом документе описывается использование Jenkins для непрерывной интеграции с приложениями Xamarin. Он описывает способ установки, настройки и использования Jenkins.
ms.prod: xamarin
...
Автоматические тесты можно передать на Test Cloud с помощью команд оболочки. Дополнительные сведения о настройке тестового запуска в Xamarin Test Cloud см. в этом руководстве по использованию [Xamarin.UITest](/appcenter/test-cloud/preparing-for-upload/uitest/).
