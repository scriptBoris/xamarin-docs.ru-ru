...
Дополнительные сведения о том, как отправить UITests облако тестирования, см. в этом руководстве на [Xamarin.UITests Подготовка для передачи](/appcenter/test-cloud/preparing-for-upload/uitest/).
