...
#### [Предварительная версия Microsoft Mobile OpenJDK](get-started/installation/openjdk.md)
...
### [Предварительная версия Android P](platform/android-p.md)
...
### [Средство запуска](~/essentials/launcher.md?context=xamarin/android)
...
### [Карты](~/essentials/maps.md?context=xamarin/android)
### [Открыть браузер](~/essentials/open-browser.md?context=xamarin/android)
### [Датчик ориентации](~/essentials/orientation-sensor.md?context=xamarin/android)
### [Телефон](~/essentials/phone-dialer.md?context=xamarin/android)
### [Power](~/essentials/power.md?context=xamarin/android)
### [Параметры](~/essentials/preferences.md?context=xamarin/android)
