...
-   **[Игнорировать]**  &ndash; Вызывает для SQLite.NET игнорировать это свойство.
    Это особенно полезно для свойства, которые имеют тип, не могут храниться в базе данных или свойств, моделирующих коллекций, которые не может быть разрешен автоматически SQLite.
