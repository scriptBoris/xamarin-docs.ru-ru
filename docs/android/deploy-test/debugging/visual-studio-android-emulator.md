...
> [!NOTE]
> Эмулятор Android для Visual Studio совместим только с Visual Studio 2015 — он не работает с Visual Studio 2017.
...
- [Эмулятор Visual Studio для Android](https://www.visualstudio.com/vs/msft-android-emulator/)
