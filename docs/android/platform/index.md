...
description: Документы в этом разделе рассматриваются возможности, предназначенные для Android. Здесь вы найдете таким темам, как использовать фрагменты, работать с картами и инкапсуляции данных с помощью поставщиков содержимого.
ms.prod: xamarin
...
ms.locfileid: "39351568"
---
# <a name="platform-features"></a>Функции платформы

_Документы в этом разделе рассматриваются возможности, предназначенные для Android. Здесь вы найдете таким темам, как использовать фрагменты, работать с картами и инкапсуляции данных с помощью поставщиков содержимого._
...
##  <a name="android-p-previewandroidplatformandroid-pmd"></a>[Предварительная версия Android P](~/android/platform/android-p.md)

В этой статье приводится обзор новых функций в предварительной версии Android P, объясняется способ подготовки для разработки приложений Android P Xamarin.Android и содержит пример кода, демонстрирующий способ использования ключевых функций P для Android в приложениях Xamarin.Android.
...
Файл AndroidManifest.xml и как это может быть статью introducts используется для управления функциями и описания требований к Mono для приложения Android.
