...
Xamarin.Android 9.0 предоставляет поддержку круговой Android в предварительной версии. Дополнительные сведения о поддержке Xamarin.Android Android круговой см. в разделе [Android P Developer Preview 3](https://developer.xamarin.com/releases/android/xamarin.android_9/xamarin.android_9.0/#android-p-dp1) заметки о выпуске.
