...
|[значение](https://docs.microsoft.com/dotnet/csharp/language-reference/keywords/value)|Ссылается на значение, которое код клиента должен присвоить свойству.|
...
- [Moving to C# and the .NET Framework, for Java Developers](https://www.microsoft.com/download/details.aspx?id=6073) (Переход на C# и .NET Framework для Java-разработчиков)
