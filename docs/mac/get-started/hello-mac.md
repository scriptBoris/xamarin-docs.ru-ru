...
Для примера Hello World права не потребуются. В следующем разделе мы рассмотрим, как изменить файл **Main.storyboard** и определить пользовательский интерфейс приложения Xamarin.Mac с помощью Interface Builder в Xcode.
